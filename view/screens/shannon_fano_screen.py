...
class ShannonFanoScreen(tk.Frame):
    def __init__(self, parent, view):
        ...
        self.results_frame = ttk.LabelFrame(self, text="Resultados de Shannon-Fano", padding=10)
        ...
        ttk.Button(button_frame, text="Comprimir Shannon-Fano", command=self._compress).pack(fill="x", pady=2)
        ttk.Button(button_frame, text="Descomprimir Shannon-Fano", command=self._decompress).pack(fill="x", pady=2)
            ...
            if file_path:
                try:
                    with open(file_path, 'r', encoding='utf-8') as f:
                        ...
                        self.controller.set_original_text(content) # Actualizar texto original en el controlador
